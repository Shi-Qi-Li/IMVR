...
def registration_metrics(predictions: Dict, ground_truth: Dict, info: Dict) -> Dict:
    abs_pose_pred = predictions["abs_pose_pred"]

    err2 = info["err2"]
    gt_file = os.path.join(info["gt_file_path"], "gt.log")
    info_file = os.path.join(info["gt_file_path"], "gt.info")
    ...
    gtlo_file = os.path.join(info["gt_file_path"], "gtLo.log")
    infolo_file = os.path.join(info["gt_file_path"], "gtLo.info")
